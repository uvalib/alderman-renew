...
> A site to detail the state of the Alderman renewal project

## Getting Started

To work with the Alderman Renewal Site you need to:
...
[Download](https://github.com/uvalib/alderman-renew/releases/latest) and extract Alderman Renewal site to where you want to work.

### Install dependencies

#### Quick-start (for experienced users)

With Node.js installed, run the following one liner from the root of your Alderman Renewal site download:
...
The full site requires the following major dependencies:
...
4)  Install the site's local `npm` and `bower` dependencies.

```sh
cd alderman-renew && npm install && bower install
```

This installs the element sets (Paper, Iron, Platinum) and tools the site requires.
...
The Alderman Renewal sites comes configured with support for [Web Component Tester](https://github.com/Polymer/web-component-tester) - Polymer's preferred tool for authoring and running unit tests. This makes testing your element based applications a pleasant experience.
...
The Alderman Renewal site offers an offline-first experience thanks to Service Worker and the [Platinum Service Worker elements](https://github.com/PolymerElements/platinum-sw). New to Service Worker? Read the following [introduction](http://www.html5rocks.com/en/tutorials/service-worker/introduction/) to understand how it works.
